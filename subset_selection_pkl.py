...
def loss_based_ranking(model, data_dict, features_dict, loader_dict,
    ...
    with open("pickles/loss_means.pkl", 'rb') as f:
        loss_means = pickle.load(f)

    with open("pickles/loss_stds.pkl", 'rb') as f:
        loss_stds = pickle.load(f)
...
def grad_based_ranking(model, data_dict, features_dict, loader_dict,
    ...
    with open("pickles/grad_means.pkl", 'rb') as f:
        grad_means = pickle.load(f)

    with open("pickles/grad_stds.pkl", 'rb') as f:
        grad_stds = pickle.load(f)
